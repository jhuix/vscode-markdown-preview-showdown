...
export class ShowdownPreviewer {
  ...
  public async saveLocalHtml(
    ...
    let bottomComment = 'This page is generated by the Markdown Preview Showdown (MDPS) VSCODE extension';
    const locale = this.config.locale.toLowerCase();
    if (locale === 'zh-cn' || locale === 'zh-hans') {
      bottomComment = '该页面是由VSCODE扩展Markdown Preview Showdown (MDPS)生成';
    }
